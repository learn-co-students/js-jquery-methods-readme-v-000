...
describe('jQuery Methods', function() {
  ...
  it('#animateIt makes div taller', function() {

    var box = $('#box');
    var o = { pass: function() { return true; } };

    spyOn(o, 'pass');

    box.animate({'height': '500px'}, 0);
    ...
    expect(o.pass).toHaveBeenCalled();
