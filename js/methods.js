...
/*Create a function fancySchmancy which does not accept
any parameters. The function should use the addClass
function to add the class iAmFancy (defined in css/style.css)
to the p tag with the ID bacon. The function should return
the p tag.*
...
/* Create a function showDolphin, which shows the hidden image
of the dolphin, using the show function. The function does not
...
/*Create a function fadeItOut which hides the second paragraph
using the fadeOut function. You'll need to pass 0 to the
fadeOut function so that the image fades immediately.
Otherwise, you'll have issues with the tests. The function
...
any parameters. The function should use the val method to
retrieve the value of the last input tag. The function
